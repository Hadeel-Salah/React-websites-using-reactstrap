      ...
      <Container>
        <Row>
          <Col lg="10" md="12" className="m-auto">
            <div className="feedback d-flex justify-content-between align-items-center ">
              <div className="w-50">
                <img src={img} alt="" className="w-100" />
              </div>

              <div className="feedback__content w-50">
                <h2 className="mb-4">Our Clients review</h2>

                <Slider {...settings}>
                  <div>
                    <div className="single__testimonial">
                      <h6 className="mb-3 fw-bold">
                        Excellent results and price
                      </h6>
                      <p>
                      ...
                      <div className="student__info mt-4">
                        <h6 className="fw-bold">James Daovd</h6>
